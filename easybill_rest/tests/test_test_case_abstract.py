...
class TestEaybillTestCaseAbstract(unittest.TestCase, EasybillRestTestCaseAbstract):

    def test_test_case_abstract(self) -> None:
        self.assertRaises(NotImplementedError, EasybillRestTestCaseAbstract.get_suite)
